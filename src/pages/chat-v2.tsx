    ...
    <div className="min-h-screen bg-dark-bg text-dark-text flex flex-col">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button
            ...
            className={`h-10 w-10 rounded-lg hover:bg-dark-bg-secondary ${
              showHistory ? 'text-blue-400 bg-blue-900/20' : 'text-dark-text-secondary'
            }`}
          >
          ...
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
              <Bot className="h-4 w-4 text-dark-text" />
            </div>
      ...
      <div className="flex-1 flex flex-col">
        {formattedMessages.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col">
            {/* Session info bar */}
            <div className="px-4 py-2 border-b border-dark-border flex items-center justify-between text-sm">
              ...
              <Button
                ...
                className="text-dark-text-secondary hover:text-dark-text h-7 px-2"
              >
